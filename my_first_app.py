...
DATE_TIME = "date/time"
DATA_URL = (
    r"C:\Users\suchit\Downloads\Motor_Vehicle_Collisions_-_Crashes.csv")

st.title("Vehicle Accidents in New York City")
...
filtered = data[
    (data[DATE_TIME].dt.hour >= hour) & (data['date/time'].dt.hour < (hour + 1))
    ]
